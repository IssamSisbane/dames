...
def depactprisepion(colonnedepart,lignedepart,colonnearrivee,lignearrivee,plateau,pion):
    depvalide=0
        ...
        for event in pygame.event.get():
            if event.type == MOUSEBUTTONDOWN:
                if event.button == 1 :
                    ...
                    elif depactprisepion(colonnecasedepart,lignecasedepart,colonne,ligne,plateau,pion)==1:
                        pion_déplace=1
                        plateau[colonnecasedepart][lignecasedepart]=0
                        plateau[colonne][ligne]=pion
